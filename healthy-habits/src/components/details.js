        ...
        <div className={`details-container ${props.type}-bkg`}>
            ...
            {props.type === "water" && <div>
                <form id="water-form" onSubmit={(e) => e.preventDefault() }>
                    ...
                    <input value={water} type="number" placeholder="Total" min="0" onChange={handleWaterChange} />           
                </form>
            ...
            {props.type === "steps" && <div> 
                <form id="steps-form" onSubmit={(e) => e.preventDefault() }>
                    ...
                    {/* TODO: Add two-way binding for the input below */}
                    <input value={steps} type="number" placeholder="Total" min="0" onChange={handleStepsChange}/>
                </form>
            ...
            {props.type === "food" && <div>
                <form id="food-form">
                    ...
                    <input value={food} type="text" className="wide" placeholder="Description of food or beverage" maxLength="32" onChange={handleFoodDescChange} />
                    <input value={foodCalories}type="number" placeholder="Calories" min="0" onChange={handleFoodCalChange} />
            ...
            {props.type === "exercise" && <div>
                <form id="exercise-form">
                    ...
                    {/* TODO: Add two-way binding for each of the two inputs below */}
                    <input value={exerciseDescription} type="text" className="wide" placeholder="Description of exercise activity" maxLength="32" onChange={handleExerciseDescChange} />
                    <input value={exerciseCalories} type="number" placeholder="Calories" min="0" onChange={handleExerciseCalChange} />
                    {/* TODO: BONUS! Make the button disabled if either field is empty */}
                    <button value={exerciseDescription} type="submit" onClick={handleSubmitExercise}>Update</button>
                </form>
                {/* TODO: BONUS! Make the log & table appear only when the first entry is submitted */}
                <div>
